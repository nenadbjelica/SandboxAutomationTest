...
public class CreateUseCaseTwo extends BaseTest {
	...
	protected void initializeTestData() throws IOException {
	    ...
	    title = ExcelUtils.getCellData(1,2);
	    description = ExcelUtils.getCellData(2,2);
	    expectedResults = ExcelUtils.getCellData(3,2);
	    useCaseStep1 = ExcelUtils.getCellData(4,2);
	    useCaseStep2 = ExcelUtils.getCellData(5,2);
	}
